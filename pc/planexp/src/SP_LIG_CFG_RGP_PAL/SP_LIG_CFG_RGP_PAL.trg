...
-- DESCRIPTION :
-- -------------
-- Triggers sur SP_LIG_CFG_RGP_PAL
CREATE OR REPLACE TRIGGER TUB_SP_LIG_CFG_RGP_PAL BEFORE UPDATE
ON SP_LIG_CFG_RGP_PAL FOR EACH ROW
BEGIN
    :new.dat_maj := SYSDATE;
...
CREATE OR REPLACE TRIGGER TIB_SP_LIG_CFG_RGP_PAL BEFORE INSERT
ON SP_LIG_CFG_RGP_PAL FOR EACH ROW
BEGIN

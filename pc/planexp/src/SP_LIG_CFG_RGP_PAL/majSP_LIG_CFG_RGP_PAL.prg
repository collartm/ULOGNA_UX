/* $Id$
****************************************************************************
* su_bas_maj_sp_lig_cfg_rgp_pal - Création ou mise à jour enregistrement table SP_LIG_CFG_RGP_PAL
*/
-- DESCRIPTION :
-- -------------
-- Fonction de création ou de mise à jour d'un enregistrement de la table SP_LIG_CFG_RGP_PAL
--
